...
from tasks.WMC.common.config import WMCConfig
from tasks.WMC.common.experiment_messages import ExperimentMessages
from tasks.WMC.common.instructions import Instructions
from PIL import Image


def run_wmc_mac(result_folder):
